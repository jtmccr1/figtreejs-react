...
import {FigTree,Nodes, NodeShape,Branch,Node,Branches,RectangularBranchPath,ImmutableTree,rectangularVertex,makeEdge} from "../index.js";	
...
const edges =   tree.getPostOrder().filter(id=>id!==tree.getRoot()).map(id=>makeEdge(rectangularVertex)(id,tree));	
     ...
     <Timeline margins={{top:10,bottom:10,left:10,right:10}} width={600} height={400} >
